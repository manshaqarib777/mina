...
{!! Form::open(['route' => ['categoria.update',$ldms_user_data->id], 'method' => 'PUT']) !!}
	<div class="row">
		<div class="col-md-6 col-md-offset-3">
			<strong>Nombre de categoría:</strong>	
			{{Form::text('categoria_name',$value = $ldms_user_data->categoria_name,array('required' => 'required', 'class' => 'form-control mar-t-b'))}}

	
		

			
			<input type="submit" value="{{trans('file.Submit')}}" class="btn btn-success">
