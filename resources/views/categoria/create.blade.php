  ...
  <div class="col-md-9">     
    ...
    <div class="col-md-12 panel">
        ...
        <div class="container-fluid">
            <a href="{{ action("DocumentController@ldmsCreate") }}"  class="btn btn-primary"><i class="fa fa-file"></i> VER DOCUMENTOS</a>
        </div>
        ...
        <div class="col-md-12"> 
          <table id="user-table" class="table table-bordered table-striped">
            ...
            <tbody>
              @foreach($ldms_user_list as $key=>$categoria)
                <tr>
                  ...
                  <td class="text-center hidden-print">
                      <div class="btn-group">
                          ...
                          <ul class="dropdown-menu dropdown-default pull-right" user="menu">
                              <li><a title = "View" href="{!! $categoria->id !!}/edit"><i class="fa fa-eye" aria-hidden="true"></i> {{trans('file.View')}}</a></li>
      ...
      <div class="form-group">
             ...
             <div class="form-group-inner">
                <div class="field-outer">
                    {{Form::text('categoria_name',null,array('required' => 'required', 'class' => 'form-control'))}}
                </div>
             </div>
