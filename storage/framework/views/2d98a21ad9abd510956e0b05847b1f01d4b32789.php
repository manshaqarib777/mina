        ...
        <div class="col-md-12"> 
            <table id="document-table" class="table table-bordered table-striped">
                <thead>
                  ...
                  <th><?php echo e(trans('file.Sub Category')); ?></th>
                  ...
                  <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> 
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <?php if($category->is_main== 1): ?>
                                <span class="h5 text-danger">  <?php echo e($category->name); ?></span></td>
                                 <?php endif; ?>
                                 
                            <td>
                                <?php if($category->is_main== 2): ?>
                           <b> <span class="h5 text-success">   - <?php echo e($category->name); ?> </span>  </b>
                                 <?php endif; ?>
                            </td>
                ...
                <div class="form-group">
                     ...
                     <div class="form-group-inner">
                         <div class="field-outer">
                             <input class="form-control" type="text" name="name" placeholder="Nombre de la categoría" required>
                         </div>
                     </div>
                </div>                   
                <div class="form-group">
                    ...
                    <div class="form-group-inner">
                         <div class="field-outer">
                           ...
                           <option disabled selected>Elige una categoría Principal</option>
        ...
        <div class="modal-body">
            <form method="post" action="<?php echo e(route('category.update')); ?>" files="true" enctype="multipart/form-data">
                ...
                <div class="form-group">
                        ...
                        <div class="form-group-inner">
                            <div class="field-outer">
                                <input class="form-control" type="text" id="cat_name" name="name" placeholder="Nombre de la categoría" required>
                            </div>
                        </div>
                </div>                   
                <div class="form-group">
